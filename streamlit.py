...
with st.form(key='my_form'):
    ...
    n_longitude = st.text.input("輸入經度")
    n_latitude = st.text.input("輸入緯度")
    n_housing_median_age = st.text.input("輸入房客年齡中位數")
    n_total_rooms = st.text.input("輸入總房間數")
    n_total_bedrooms = st.text.input("輸入總臥室數")
    n_population = st.text.input("輸入總人口數")
    n_households = st.text.input("輸入總家庭數")
    n_median_income = st.text.input("輸入收入中位數")
